...
class RandomTxSpiderSpider(scrapy.Spider):
    ...
    def __init__(self, **kwargs):
        ...
        self.out_path = kwargs.get('out', './data/Random')  # 输出文件夹路径
        ...
        if self.has_evaluator:
            ...
            self.evaluator = StrategyEvaluator(
                ...
                log_name='Random_' + str(time.time()),
            )
    ...
    def parse(self, response, **kwargs):
        ...
        if data['result'] is None or len(data['result']) < 10000:
            while self.has_next(kwargs['seed']):
